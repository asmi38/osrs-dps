...
export const tierSix = (
  <div>
    <p>All attacks have 10% increased accuracy and damage</p>
  </div>
)

export const konarsBlessing = (
  <div>
    <p>10% Increased accuracy and damage</p>
    <p>30% If monster is a slayer task</p>
  </div>
)

export const xericsFocus = (
  <div>
    <p>Attack speed of weapons sped up by 1</p>
  </div>
)
